...
write.table(gender_sector_salarygroup, file = "gender_salary_sector.csv", row.names=FALSE, col.names=FALSE, sep=",", quote = FALSE)

gender_sector_salarygroup_2011 <- salaries_g3 %>% filter(Year==2011) %>% group_by(name) %>% summarise(count = n())
write.table(gender_sector_salarygroup_2011, file = "gender_salary_sector_2011.csv", row.names=FALSE, col.names=FALSE, sep=",", quote = FALSE)

gender_sector_salarygroup_2012 <- salaries_g3 %>% filter(Year==2012) %>% group_by(name) %>% summarise(count = n())
write.table(gender_sector_salarygroup_2012, file = "gender_salary_sector_2012.csv", row.names=FALSE, col.names=FALSE, sep=",", quote = FALSE)

gender_sector_salarygroup_2013  <- salaries_g3 %>% filter(Year==2013) %>% group_by(name) %>% summarise(count = n())
write.table(gender_sector_salarygroup_2013, file = "gender_salary_sector_2013.csv", row.names=FALSE, col.names=FALSE, sep=",", quote = FALSE)

gender_sector_salarygroup_2014 <- salaries_g3 %>% filter(Year==2014) %>% group_by(name) %>% summarise(count = n())
write.table(gender_sector_salarygroup_2014, file = "gender_salary_sector_2014.csv", row.names=FALSE, col.names=FALSE, sep=",", quote = FALSE)
```
