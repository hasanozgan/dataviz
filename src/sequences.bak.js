...
d3.text("gender_salary_sector.csv", function(text) {
  var csv = d3.csv.parseRows(text);
  var json = buildHierarchy(csv);
  createVisualization(json);
});

d3.select("#show2011").on("click", function() {
  d3.text("gender_salary_sector_2011.csv", function(text) {
    var csv = d3.csv.parseRows(text);
    var json = buildHierarchy(csv);
    ...
    var path = d3.select("#chart").data([json]).selectAll("path")
        .data(nodes)
...
//   });
//
//     d3.select("#chart").update()
// });
//
// d3.select("#show2012").on("click", function() {
//
//   d3.text("gender_salary_sector_2012.csv", function(text) {
//     var csv = d3.csv.parseRows(text);
//     var json = buildHierarchy(csv);
//     var nodes = partition.nodes(json)
//         .filter(function(d) {
